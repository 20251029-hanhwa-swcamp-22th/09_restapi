package com.kth.springsecurity.auth.service;

import com.kth.springsecurity.auth.dto.LoginRequest;
import com.kth.springsecurity.auth.dto.TokenResponse;
import com.kth.springsecurity.auth.entity.RefreshToken;
import com.kth.springsecurity.auth.repository.AuthRepository;
import com.kth.springsecurity.command.entity.User;
import com.kth.springsecurity.command.repository.UserRepository;
import com.kth.springsecurity.jwt.JwtTokenProvider;
...
public class AuthService {
  ...
  public TokenResponse refreshToken(String provideRefreshToken) {
    ...
    // DB에 전달된 토큰의 만료 기간이 현재 시간 보다 과거인지 확인
    // (만료 기간이 지났는지 확인)
