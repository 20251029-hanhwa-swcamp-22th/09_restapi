package com.kth.cqrs.product.command.application.service;

import com.kth.cqrs.common.service.FileStorageService;
import com.kth.cqrs.exception.BusinessException;
import com.kth.cqrs.exception.ErrorCode;
import com.kth.cqrs.product.command.application.dto.request.ProductCreateRequest;
import com.kth.cqrs.product.command.application.dto.request.ProductUpdateRequest;
import com.kth.cqrs.product.command.domain.aggregate.Product;
import com.kth.cqrs.product.command.domain.aggregate.ProductStatus;
import com.kth.cqrs.product.command.domain.repository.ProductRepository;
