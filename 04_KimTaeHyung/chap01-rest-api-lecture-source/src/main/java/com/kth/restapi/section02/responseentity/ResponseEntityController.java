package com.kth.restapi.section02.responseentity;
...
public class ResponseEntityController {
  ...
  public ResponseEntityController(ResourcePatternResolver resourcePatternResolver) {
    users = new ArrayList<>();
...
//    return new ResponseEntity<>(responseMessage, httpHeaders, HttpStatus.OK);
  ...
  public ResponseEntity<ResponseMessage> findUserByNumber(
